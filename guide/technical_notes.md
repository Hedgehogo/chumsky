...
See [`UnitParser::ignore_with_ctx`] and [`UnitParser::then_with_ctx`]for more information.
...
[`UnitParser::map`], which accept a user-provided closure. However, chumsky has no control over the behaviour of this
...
[string interning](https://en.wikipedia.org/wiki/String_interning) within [`UnitParser::map_with`] is an impure operation,
